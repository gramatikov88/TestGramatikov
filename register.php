    ...
    <main class="container my-4 my-md-5 d-flex justify-content-center">
        <div class="card shadow-sm auth-card w-100">
            <div class="card-body p-4 p-md-5">
                ...
                <p class="text-muted mb-4">Регистрирай се като ученик или учител, за да използваш пълната функционалност
                    на платформата.</p>
                ...
                <form method="post" novalidate>
                    ...
                    <div class="row g-3">
                            ...
                            <div class="d-flex gap-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="role" id="roleStudent"
                                        value="student" <?= $posted['role'] === 'student' ? 'checked' : '' ?> />
                                    <label class="form-check-label" for="roleStudent">Ученик</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="role" id="roleTeacher"
                                        value="teacher" <?= $posted['role'] === 'teacher' ? 'checked' : '' ?> />
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="first_name" name="first_name"
                                value="<?= htmlspecialchars($posted['first_name']) ?>" required />
                        </div>
                        <div class="col-md-6">
                            <label for="last_name" class="form-label">Фамилия</label>
                            <input type="text" class="form-control" id="last_name" name="last_name"
                                value="<?= htmlspecialchars($posted['last_name']) ?>" required />
                        </div>
                        <div class="col-12">
                    ...
                    <div class="d-flex align-items-center justify-content-between mt-4">
                        <div class="text-muted small">С регистрирането приемате <a href="terms.php">условията за
                                ползване</a>.</div>
                        <button type="submit" class="btn btn-primary"><i
                                class="bi bi-person-plus me-1"></i>Регистрация</button>
                    </div>
                </form>
