...
$pdo = null; $homeCategories = []; $recentTests = []; $popularStr = '';
try {
    $pdo = db();
        ...
        <div class="row align-items-center g-4 g-md-5">
            <div class="col-lg-7">
                ...
                <div class="d-flex flex-wrap gap-2">
                    <a href="tests.php?mode=quick" class="btn btn-light btn-lg"><i class="bi bi-play-fill me-1"></i>Започни бърз тест</a>
                    <a href="tests.php" class="btn btn-outline-light btn-lg"><i class="bi bi-collection me-1"></i>Разгледай тестовете</a>
                </div>
            </div>
            <div class="col-lg-5">
                <div class="glass rounded-4 p-3 p-md-4 bg-white text-dark">
                    ...
                    <form action="tests.php" method="get" class="input-group input-group-lg">
                        <input type="text" class="form-control" name="q" placeholder="Ключова дума, тема или клас..." aria-label="Търсене на тестове" />
                        <button class="btn btn-primary" type="submit"><i class="bi bi-search"></i></button>
                    </form>
                    <div class="small text-muted mt-2">Популярни: <?= htmlspecialchars($popularStr ?: 'граматика, лексика, пунктуация, математика') ?></div>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="col-md-4">
                <div class="card h-100 shadow-sm">
                    <div class="card-body">
                        ...
                        <p class="card-text">Въпросите се напасват според твоето ниво за максимално ефективно учене.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
    ...
    <section class="mb-5">
        ...
        <div class="row g-3 g-md-4">
            <?php if ($homeCategories): ?>
                ...
                <?php endforeach; ?>
            <?php else: ?>
                <div class="col-12"><div class="text-muted">Няма налични категории.</div></div>
            <?php endif; ?>
        </div>
    </section>
        ...
        <div class="list-group shadow-sm">
            <?php if ($recentTests): ?>
                <?php foreach ($recentTests as $rt): ?>
                    <a href="test_view.php?test_id=<?= (int)$rt['id'] ?>" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
...
<footer class="border-top py-4">
    <div class="container d-flex flex-column flex-md-row justify-content-between align-items-center gap-2">
        <div class="text-muted">© <?php echo date('Y'); ?> TestGramatikov</div>
