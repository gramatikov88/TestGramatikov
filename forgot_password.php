    ...
    <main class="container my-4 my-md-5 d-flex justify-content-center">
        <div class="card shadow-sm auth-card w-100">
            <div class="card-body p-4 p-md-5">
                ...
                <p class="text-muted mb-4">Въведете имейла, с който сте регистриран. Ще получите имейл с линк за промяна
                    на паролата.</p>
                ...
                <form method="post" novalidate>
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <button type="submit" class="btn btn-primary"><i class="bi bi-send me-1"></i>Изпрати
                            линк</button>
                    </div>
                </form>
            </div>
