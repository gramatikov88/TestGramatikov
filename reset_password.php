    ...
    <main class="container my-4 my-md-5 d-flex justify-content-center">
        <div class="card shadow-sm auth-card w-100">
            <div class="card-body p-4 p-md-5">
                ...
                <p class="text-muted mb-4">Изберете силна парола, която не сте използвали преди. Тя трябва да е поне 8
                    символа.</p>
                ...
                <form method="post" novalidate>
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        <a class="small" href="forgot_password.php"><i class="bi bi-envelope me-1"></i>Изпратете нов
                            линк</a>
                        <button type="submit" class="btn btn-primary"><i class="bi bi-check2-circle me-1"></i>Запази
                            новата парола</button>
                    </div>
                </form>
            </div>
        </div>
