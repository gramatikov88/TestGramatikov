...
$stmt = $pdo->prepare('SELECT a.*, t.title AS test_title
                       FROM assignments a
...
<main class="container py-4">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4">
        <div>
            <h1 class="h3 mb-1"><?= htmlspecialchars($assignment['title']) ?></h1>
    ...
    <div class="row g-3 g-md-4 mb-4">
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="card shadow-sm h-100">
                <div class="card-body">
                    <div class="text-muted small text-uppercase mb-1">Подадени</div>
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="card shadow-sm h-100">
                <div class="card-body">
                    <div class="text-muted small text-uppercase mb-1">За оценяване</div>
